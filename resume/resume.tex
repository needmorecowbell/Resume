...
\name{Adam}{Musciano}
\position{Web Developer{\enskip\cdotp\enskip}Maker{\enskip\cdotp\enskip} Python Enthusiast}
%\address{246-1002, Gwangmyeongmayrouge Apt. 86, Cheongna lime-ro, Seo-gu, Incheon-si, 404-180, Rep. of KOREA}

\mobile{(+1) 412-613-8065}
\email{amusciano@gmail.com}
\homepage{www.adammusciano.com}
\github{needmorecowbell}
\linkedin{amusciano}
% \gitlab{gitlab-id}
